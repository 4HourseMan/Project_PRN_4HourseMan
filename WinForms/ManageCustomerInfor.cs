...
namespace WinForms
{
    public partial class ManageCustomerInfor : Form, IManageCustomerView
    {
        private ManageCustomerPresenter MCP;
        public ManageCustomerInfor()
        {
            InitializeComponent();
        ...
        private void ManageCustomerInfor_Load(object sender, System.EventArgs e)
        {
            LoadData();
        }
